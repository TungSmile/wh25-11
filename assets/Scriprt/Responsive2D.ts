import { _decorator, Component, Node, CCFloat, Enum, view, UITransform, screen, find, Vec3, Canvas, tween, log, Layout } from 'cc';
                ...
                if (width > height) {
                    switch (this.node.name) {
                        case 'Logo':
                            ...
                            ratio < 1.6 ? horSpace = ratio * 9 : 0;
                            break;
                        case 'table':
                            // if (ratio < 1.6) {
                            //     this.node.getComponent(UITransform).setContentSize(1500, 130);
                            //     splittedAlignment[1] = "bottom";
                            //     splittedAlignment[2] = "center";
                            ...
                            this.node.getComponent(UITransform).setContentSize(50, 300);
                            this.node.getComponent(Layout).paddingLeft = 0
                            this.node.getComponent(Layout).paddingTop = 50
                            this.node.getComponent(Layout).paddingBottom = 50
                            ...
                            break;
                        case 'Title':
                            this.node.getChildByName("title").setScale(new Vec3(1, 0.7, 0))
                        ...
                        case 'Game':
                            ...
                            // }
                            this.node.getComponent(UITransform).setContentSize(650, 700);
                            // this.node.getChildByName("TM").setPosition(new Vec3(0, 0, 0))
                ...
                if (width < height) {
                    switch (this.node.name) {
                        ...
                        case 'table':
                            // this.node.setRotationFromEuler(new Vec3(0, 0, 0));
                            // if (ratio > 0.67) {
                            //     this.node.getComponent(UITransform).setContentSize(1000, 300);
                            // } else

                            this.node.getComponent(UITransform).setContentSize(300, 50);
                            this.node.getComponent(Layout).paddingLeft = 25;
                            this.node.getComponent(Layout).paddingTop = 0
                            this.node.getComponent(Layout).paddingBottom = 0
                            break;
                        case 'Game':
                            // if (ratio > 0.67) {
                            //     this.node.getComponent(UITransform).setContentSize(1400, 1400);
                            //     verSpace = 12.5;
                            // } else
                            //     this.node.getComponent(UITransform).setContentSize(1400, 1800);
                            this.node.getComponent(UITransform).setContentSize(550, 700);
                            // this.node.getChildByName("TM").setPosition(new Vec3(0, 500, 0))

                            break;
                        case 'Title':
                            this.node.getChildByName("title").setScale(new Vec3(1, 1, 0))
